...
function initModel(app,model){
    ...
    userID: {type: Number,required: true},
	  ...
	  modify_time: {type: Date, default: Date.now,  required: true},
		...
		address: {type: String,required: true,default: "beijing",desc: "建材生产地址"},
		product_type_id: {    type: Number,  required: true  },
		is_alive: {  type: Boolean,  required: true,default: false  },
	  isPass: {    type: Boolean,required: true,default: false    },
	  brand_id: {    type: Number,required: true  },  category_id: {
